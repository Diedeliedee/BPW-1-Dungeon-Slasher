...
public class Weapon : MonoBehaviour
{
    ...
    //  Run-time:
    private Overlapper<Agent> m_overlapper = null;

    //  Reference:
    private Agent m_root = null;

    public void Setup(Agent agent, LayerMask mask)
    {
        m_root = agent;
        m_overlapper = new Overlapper<Agent>(m_radius, mask);
    }
